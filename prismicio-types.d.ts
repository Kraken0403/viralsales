...
export interface ProductCardSliceDefaultItem {
  ...
  /**
   * Product Description field in *ProductCard → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: product_card.items[].product_description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  product_description: prismic.RichTextField;

  /**
   * Feature One field in *ProductCard → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: product_card.items[].feature_one
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  feature_one: prismic.KeyTextField;

  /**
   * Feature Two field in *ProductCard → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: product_card.items[].feature_two
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  feature_two: prismic.KeyTextField;

  /**
   * Feature Three field in *ProductCard → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: product_card.items[].feature_three
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  feature_three: prismic.KeyTextField;

  /**
   * Feature Four field in *ProductCard → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: product_card.items[].feature_four
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  feature_four: prismic.KeyTextField;

  /**
   * Feature Five field in *ProductCard → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: product_card.items[].feature_five
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  feature_five: prismic.KeyTextField;

  /**
   * Feature Six field in *ProductCard → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: product_card.items[].feature_six
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Item in *ProjectCard → Default → Primary → Project Info*
 */
export interface ProjectCardSliceDefaultPrimaryProjectInfoItem {
  /**
   * Project Image field in *ProjectCard → Default → Primary → Project Info*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: project_card.default.primary.project_info[].project_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  project_image: prismic.ImageField<never>;

  /**
   * Project Title field in *ProjectCard → Default → Primary → Project Info*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project_card.default.primary.project_info[].project_title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  project_title: prismic.KeyTextField;

  /**
   * Project Description field in *ProjectCard → Default → Primary → Project Info*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project_card.default.primary.project_info[].project_description
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  project_description: prismic.KeyTextField;

  /**
   * Project Tags field in *ProjectCard → Default → Primary → Project Info*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project_card.default.primary.project_info[].project_tags
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ProjectCardSliceDefaultPrimary {
  /**
   * Project Info field in *ProjectCard → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: project_card.default.primary.project_info[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  project_info: prismic.GroupField<
    Simplify<ProjectCardSliceDefaultPrimaryProjectInfoItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ProjectCardSlice,
      ProjectCardSliceDefaultPrimaryProjectInfoItem,
