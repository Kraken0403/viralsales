        ...
        <div class="menu-wrapper" id="menu">
          <div class="menu-container">
            ...
            <div class="menu-right">
              ...
              <div class="menu-items">
                <div class="menu-item">
                  <nuxt-link to="/products" @click="toggleMenu">Products</nuxt-link>
                </div>

                <div class="menu-item">
                  <nuxt-link to="/projects" @click="toggleMenu">Projects</nuxt-link>
                </div>
                ...
                <div class="menu-item">
                  <nuxt-link to="/contact-us" @click="toggleMenu">Contact Us</nuxt-link>
                </div>
    ...
    methods: {
      toggleMenu() {
        ...
        if (this.isMenuOpen) {
          ...
          gsap.to(".overlay", { opacity: 1,  duration: 0.3, delay: 0.4, onComplete: function() {
          ...
          gsap.to(".overlay", { opacity: 0,  duration: 0.3, delay: 0.2, onComplete: function() {
